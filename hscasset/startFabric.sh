...
Next, use the hscasset applications to interact with the deployed hscasset contract.
The hscasset applications are available in multiple programming languages.
