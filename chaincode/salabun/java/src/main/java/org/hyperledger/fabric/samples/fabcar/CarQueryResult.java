 ...
 */
@DataType()
public final class SalabunQueryResult {
    @Property()
    private final String key;

    @Property()
    private final Salabun record;

    public SalabunQueryResult(@JsonProperty("Key") final String key, @JsonProperty("Record") final Salabun record) {
        this.key = key;
        this.record = record;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        SalabunQueryResult other = (SalabunQueryResult) obj;
